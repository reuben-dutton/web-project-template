...
@respx.mock
@pytest.mark.anyio
async def test_retries_unused(retry_client):
    """
...
@respx.mock
@pytest.mark.anyio
async def test_retries_used(retry_client):
    """
...
@respx.mock
@pytest.mark.anyio
async def test_max_retries_used(retry_client):
    """
    Check that, given a response contains a status code 4xx,
...
@respx.mock
@pytest.mark.anyio
async def test_global_limits_adhered(global_limited_client):
    """
...
@respx.mock
@pytest.mark.anyio
async def test_domain_limits_adhered(domain_limited_client):
    server_response = utils.construct_delayed_response(0)
